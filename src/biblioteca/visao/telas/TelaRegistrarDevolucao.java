...
public class TelaRegistrarDevolucao extends JFrame {
    ...
    public TelaRegistrarDevolucao(String idBibliotecaria) {
        ...
        for (Emprestimo emp : EmprestimoControle.listarEmprestimosAtivos()) cmbEmprestimo.addItem(emp);
        ...
        btnRegistrar.addActionListener(e -> {
            ...
            if (EmprestimoControle.registrarDevolucao(emprestimo.getIdEmprestimo(), this, idBibliotecaria)) {
                dispose();
